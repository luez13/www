...
if ($id_curso == 0) { echo "<div class='alert alert-danger'>ID de curso no válido</div>"; exit; }

$curso_contenido = $curso->obtener_curso($id_curso);

// Validar si existe el curso
if (!$curso_contenido) { echo "<div class='alert alert-danger'>Curso no encontrado</div>"; exit; }
...
<div class="container mt-4 mb-5">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            ...
            <p class="mb-0 fst-italic text-white-50">Tipo: <?php echo htmlspecialchars($curso_contenido['tipo_curso']); ?></p>
        </div>
        <div class="card-body">
            ...
            <ul class="list-group list-group-flush mt-3 mb-4">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-secondary rounded-pill"><?php echo htmlspecialchars($nombre_promotor); ?></span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <li class="list-group-item">
                    ...
                    <span class="ms-4">
                        ...
                        (<?php echo date("g:i a", strtotime($curso_contenido['horario_inicio'])); ?> - <?php echo date("g:i a", strtotime($curso_contenido['horario_fin'])); ?>)
                    </span>
                </li>
                 <li class="list-group-item">
            ...
            <div class="accordion" id="accordionModulos">
                ...
                if(empty($modulos)) { echo '<p class="text-muted mt-2">No hay módulos registrados.</p>'; }
                ...
                <?php else: ?>
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <?php if ($inscripcion['completado'] != 1): ?>
                            <form method="POST" action="../controllers/curso_acciones.php" onsubmit="return confirm('¿Cancelar inscripción?');">
                            ...
                            <a href="../controllers/generar_constancia.php?id_curso=<?php echo $id_curso; ?>" target="_blank" class="btn btn-outline-primary">
...
<?php if (!$is_ajax) { include '../views/footer.php'; } ?>

<div class="modal fade" id="modalAranceles" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title text-dark"><i class="fas fa-exclamation-triangle me-2"></i>Validación requerida</h5>
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-secondary border-left-warning">
                    <small><strong>Nota:</strong> El documento digital se emite automáticamente. Para obtener <strong>firmas y sellos húmedos</strong>, debe validar el pago del arancel administrativo en la caja de la universidad.</small>
                </div>
            </div>
...
(function() {
    ...
    if(formInscribir) {
        formInscribir.addEventListener('submit', function(e) {
            ...
            .then(r => r.text())
            .then(res => {
                // Recargamos SOLO esta vista usando la función global loadPage
                // Esto es seguro porque main.js ya está cargado
