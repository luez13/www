...
if ($id_curso === 0) {
    echo '<div class="alert alert-danger">Error ID.</div>';
    exit;
}
                            ...
                            <?php foreach ($materias as $mat): ?>
                                <th style="min-width: 150px;">
                                    ...
                                    <button class="btn btn-primary btn-sm btn-block mt-1"
                                        onclick="abrirEvaluacionMateria(<?= $mat['id_materia_bimestre'] ?>, '<?= h($mat['nombre_materia']) ?>')">
    ...
    <div class="modal-dialog modal-xl-custom">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"><i class="fas fa-book-open"></i> Evaluación: <span id="lblMateriaNombre"></span>
                </h5>
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs mb-3" id="tabsEvaluacion" role="tablist">
                    <li class="nav-item">
                        <button class="nav-link active" id="tab-notas-btn" data-bs-toggle="tab"
                            data-bs-target="#tab-notas" type="button">
                            <i class="fas fa-user-graduate"></i> Cargar Calificaciones
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link text-danger" id="tab-plan-btn" data-bs-toggle="tab"
                            data-bs-target="#tab-plan" type="button">
                ...
                <div class="tab-content" id="contentEvaluacion">
                    ...
                    <div class="tab-pane fade" id="tab-plan">
                        <div class="alert alert-warning">
                            ...
                            <strong>Atención:</strong> Modificar el plan borrará las notas cargadas si cambia la
                            estructura. Asegúrese de que la suma sea 100%.
                        </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th><button class="btn btn-success btn-sm" onclick="agregarFilaPlan()"><i
