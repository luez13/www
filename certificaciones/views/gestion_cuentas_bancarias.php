                            ...
                            <?php foreach ($cuentas as $c): ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-left small">
                                        <?php if (!empty($c['telefono'])) echo '<i class="fas fa-phone fa-fw text-muted"></i> ' . h($c['telefono']) . '<br>'; ?>
                                        <?php if (!empty($c['correo'])) echo '<i class="fas fa-envelope fa-fw text-muted"></i> ' . h($c['correo']); ?>
                                        <?php if (empty($c['telefono']) && empty($c['correo'])) echo '<i class="text-muted">Sin contacto</i>'; ?>
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <button class="btn btn-sm btn-warning shadow-sm" onclick="editarCuenta(<?= htmlspecialchars(json_encode($c), ENT_QUOTES, 'UTF-8') ?>)" title="Editar Cuenta">
...
<div class="modal fade" id="modalCuenta" tabindex="-1" role="dialog" aria-labelledby="modalCuentaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="modalCuentaLabel"><i class="fas fa-university me-2"></i> <span>Nueva Cuenta Bancaria</span></h5>
                ...
                <div class="modal-body bg-light">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control" id="banco" name="banco" placeholder="Ej: Banesco, Mercantil, Zelle" required>
                        </div>
                        
                        <div class="col-md-6 form-group">
                            <label class="font-weight-bold">Titular de la Cuenta <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="titular" name="titular" placeholder="Nombre de la persona o institución" required>
                        </div>

                        <div class="col-md-4 form-group">
                            <label class="font-weight-bold">Cédula o RIF <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="cedula_rif" name="cedula_rif" placeholder="V-12345678 / J-12345678" required>
                        </div>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" class="form-control" id="numero_cuenta" name="numero_cuenta" placeholder="0134-...">
                        </div>

                        <div class="col-md-6 form-group">
                            <label class="font-weight-bold">Teléfono (Opcional - Para Pago Móvil)</label>
                            <input type="text" class="form-control" id="telefono" name="telefono" placeholder="0414-1234567">
                        </div>
                    ...
                    <div class="form-group mt-3">
                        <div class="custom-control custom-switch">
                            ...
                            <label class="custom-control-label font-weight-bold cursor-pointer" for="activo">Habilitar esta cuenta para recibir pagos</label>
                        </div>
                        <small class="form-text text-muted">Si desmarcas esta opción, la cuenta se guardará pero no le aparecerá a los estudiantes.</small>
                    </div>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-times me-1"></i> Cancelar</button>
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i> Guardar Cuenta</button>
                </div>
            </form>
        </div>
    </div>
