...
echo '<option value="masterclass_rectoria">MasterClass Rectoría</option>';
echo '<option value="taller_rectoria">Taller Rectoría</option>';
echo '<option value="curso_rectoria">Curso Rectoría</option>';
echo '<option value="seminario_rectoria">Seminario Rectoría</option>';
echo '<option value="diplomado_rectoria">Diplomado Rectoría</option>';
echo '<option value="congreso_rectoria">Congreso Rectoría</option>';
echo '<option value="charla_rectoria">Charla Rectoría</option>';
echo '</select></p>';  
